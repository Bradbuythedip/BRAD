...
### Code
- **Total files**: 27
- **Python files**: 13 (core + bot + demos)
- **Lines of code**: ~3,500+
...
│  • demo.py - Quick demo                 │
│  • interactive.py - REPL                │
│  • visualize.py - ASCII animation       │
└─────────────────────────────────────────┘
                  ↓
┌─────────────────────────────────────────┐
│  CORE ARCHITECTURE                      │
│  • engine.py - Orchestrator             │
│  • world_model.py - Level 0             │
│  • self_model.py - Level 1              │
│  • meta_cognitive.py - Level 2          │
│  • global_workspace.py - Broadcasting   │
│  • structures.py - Data types           │
└─────────────────────────────────────────┘
```
...
3. **Engage AI/consciousness community**
   - Tweet at @sama, @karpathy, @ylecun (carefully!)
   - Engage with AI consciousness discourse
   - Use hashtags: #AI #Consciousness #StrangeLoops #SystemThinking
...
2. **Submit to arXiv**
   ...
   - Also: q-bio.NC (Neuroscience), cs.LG (Machine Learning)
...
- "I can't prove I'm consistent and I've made peace with it"
...
- Create new content (tweets, blog posts)
- Community AMA
...
- **Theory**: Hofstadter, Kahneman, Baars, Gödel
